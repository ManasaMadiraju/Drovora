...
export default {
  ...
  theme: {
    extend: {
      colors: {
        brand: {
          50: '#eef4ff', 100: '#dbe6ff', 200: '#bdd0ff', 300: '#93b0ff', 400: '#6386ff',
          500: '#3f5eff', 600: '#2a3bf5', 700: '#222dd6', 800: '#2029ac', 900: '#1f2887', 950: '#141653',
        },
        ink: {
          50: '#f7f8fa', 100: '#eef0f4', 200: '#dcdfe6', 300: '#bcc1cd', 400: '#8b92a3',
          500: '#666e82', 600: '#4d5468', 700: '#3a4054', 800: '#262b3d', 900: '#171a26', 950: '#0d0f17',
        },
        coral: {
          400: '#ff8266', 500: '#ff6b4a', 600: '#ff5a36', 700: '#e8481f', 800: '#c23916',
        },
      },
      fontFamily: {
      ...
      boxShadow: {
        ...
        glow: '0 0 0 4px rgb(63 94 255 / 0.12)',
      },
      borderRadius: {
        xl2: '1.25rem',
      },
